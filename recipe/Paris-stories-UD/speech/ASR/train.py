...
class ASR(sb.core.Brain):
    ...
    def on_stage_end(self, stage, stage_loss, epoch):
        ...
        if stage == sb.Stage.TRAIN:
            ...
            with open(self.hparams.train_output, "w") as w:
        ...
        if stage == sb.Stage.VALID:
            with open(self.hparams.valid_output, "w", encoding="utf-8") as f_out:
...
if __name__ == "__main__":
    ...
    # Train
    asr_brain.hparams.wer_file = hparams["output_folder"] + "/wer_train.txt"
    asr_brain.evaluate(
        train_data,
        min_key="wer",
